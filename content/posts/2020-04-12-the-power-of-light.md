...
cover : "../images/the-power-of-light.jpg"
---

You see the light interact as particles, and like when gazing at the stars and the universe — if you zoom out enough the light changes —, this means that as you back out further, the light you see plays with itself and changes according to its own nature.

Light is something quite interesting since we have realized that it can behave like a particle, but it can also behave like a wave. This is so incredible, this means that light lives in some sort of duality, where sometimes it's fixated and other times it's moving.
...
Once light reaches our eyes it is processed and absorbed by the iris, from each eye, and then this information travels from our eyes towards the brain, where all of this information gets processed, realy quickly, and our world is created.
...
This is what being warm is and it is what the sun is meant to do: excite, illuminate, keep in the light, warm. 
...
Eventually, the human race will be capable of going to / visiting nearby stars. This means that we would seek other means of life. This means that we would seek another planetary system to keep us alive.
